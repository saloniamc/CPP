...
class Child : private Parent // Child class privately inherits the Parent class
{
private:
    // private member of parent class are present here but they are invisibly inherited.
public:
    void funChild()
    {
...
public:
    void funGrandChild()
    {
        ...
        // b = 5;     b and c are inherited protected members and hence not accesible here.
        // c = 20;
    }
};
